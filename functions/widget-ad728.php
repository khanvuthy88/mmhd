...
function __construct() {
	...
	$widget_ops = array(
		...
		'description' => __('A widget for 728 x 90 ad (Single banner)', 'mythemeshop')
	);
	...
	// Create the widget
	parent::__construct( 'mts_ad_728_widget', __('MyThemeShop: 728x90 Ad', 'mythemeshop'), $widget_ops, $control_ops );
